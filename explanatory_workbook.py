...
# Finally, we challenge the stepfinder by feeding it a set of increasingly noisy traces.
...
# -
# Since we made all those functions before, this can be executed in only a couple lines of code:
